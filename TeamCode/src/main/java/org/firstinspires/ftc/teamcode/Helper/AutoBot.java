...
public class AutoBot extends Robot{
    ...
    public void initVuforia(){
        ...
        VuforiaLocalizer.Parameters parameters = new VuforiaLocalizer.Parameters(cameraMonitorViewId); // --> Use to show camera view on RC Phone
        // VuforiaLocalizer.Parameters parameters = new VuforiaLocalizer.Parameters();  // --> Use to hide camera view on RC Phone
